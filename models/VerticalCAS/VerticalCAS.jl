...
for i in 1:9
    ...
    advisory2controller[adv] = read_NNet(path)
end;
...
for hdot0_0i in hdot0_0
    ...
    print(io, "VCAS central acceleration,h'(0) = $hdot0_0i,$result,$(res.time)\n");
end
...
savefig(fig, joinpath(TARGET_FOLDER, "VerticalCAS.png"))
